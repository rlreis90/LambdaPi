This project is a port of Andres Löh's, Conor McBride's and Wouter Swierstra's paper "A tutorial implementation of a dependently typed lambda calculus" (thus called "Lambda Pi") into GitHub for tinkering.
